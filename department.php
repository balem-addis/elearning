...
function check()
{
        ...
        var cname = document.getElementById('departmentname');
	...
	var sem = document.getElementById('sem');
		  ...
		  if(isAlphanumeric( cname, "Please fill Department Name ")){
...
<form action="department.php" method="post" name="register" onSubmit=" return check()">
<fieldset><legend  align="center" class="mujib"> department registration form</legend><br><br>
  <span class="mujib">
  
  Deapartment Name&nbsp;
  <input type="text" name="departmentname" id="departmentname" size="20%"><br><br>
...
$reg=mysqli_query($conn,"insert into department values('','$departmentname')");
if($reg){
	
echo "registered successfully!!";
echo'<meta content="3;department.php" http-equiv="refresh"/>';
}
			else
			{
