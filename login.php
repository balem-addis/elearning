...
<input type='submit' value='Login' name='login' class="button_example">&nbsp;&nbsp;&nbsp;
<input type='reset' value='Cancel'class="button_example"/></td></tr></table><br>
<?php
 if(isset($_POST['login']))
 {
  ...
  if($role=='instructor')
  {
	...
	{
	   //session_start();
		$_SESSION['instructorid']=$a['instructorid'];
