...
<form action="inactiveinstructorhead.php" method="post">


<?php


    $result_set = mysqli_query($conn,"SELECT * FROM instructor where status='off'");
if(!$result_set)
	{
...
echo"<td><a href=edithead.php?id=".$row['instructorid'].">Edit Status</a></td>";
