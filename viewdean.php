...
//include("connection.php");
    ...
    $result_set =mysqli_query($conn,"SELECT * FROM account");
...
<tr style="background-image:url(images/headerbg.png)" border="0" ><td align="center"   >Copyright © 2021 BTVTC ELMS.</td>
</tr>
