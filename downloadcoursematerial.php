...
<form action="downloadcoursematerial.php" method="post" name="upload"enctype="multipart/form-data" onSubmit="return check()">
<center>SELECT coursename<br><br>
<?php
 //include('connection.php');
...
echo'<br>';
echo'<br>';?>
<center><input type='submit' value='search' name='download' /></center>&nbsp;&nbsp;&nbsp;
...
echo' <meta content="5;downloadcoursematerial.php" http-equiv="refresh" />';
}
if(!$result_set)
	{
...
echo"<td>";echo $muj1["coursename"]; echo"</td>";
