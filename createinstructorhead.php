...
<form action="createinstructorhead.php" method="post" onSubmit="return check()">
<fieldset>
...
$re=mysqli_query($conn,"insert into account (`instructorid`,`studentid`,`username`,`password`,`usertype`) values ('$instructorid','','$fname','$instructorid','$utype')");
if($reg){
	
echo "successfully created !!";
 echo'<meta content="3;createinstructorhead.php" http-equiv="refresh"/>';
}
			else
			{
...
<tr style="background-image:url(images/headerbg.png)" border="0" ><td align="center"   >Copyright \A9 2021 BTVTC ELMS. All rights reserved.</td>
</tr>
